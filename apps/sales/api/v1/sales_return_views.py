...
@api_login_required
@api_rate_limit(
    scope="sales_returns.collection",
    limit=120,
    window_seconds=60,
)
def sales_return_collection_api(
    request,
):
    ...
    if request.method == "POST":
        ...
        except SalesReturnAPIStateError as exc:
            return (
                APIResponseService
...
@api_login_required
@api_rate_limit(
    scope="sales_returns.detail",
    limit=120,
    window_seconds=60,
)
def sales_return_detail_api(
    request,
    sales_return_id,
):
    if request.method != "GET":
...
@api_login_required
@api_rate_limit(
    scope="sales_returns.confirm",
    limit=60,
    window_seconds=60,
)
def sales_return_confirm_api(
    request,
    sales_return_id,
):
    if request.method != "POST":
...
@api_login_required
@api_rate_limit(
    scope="sales_returns.cancel",
    limit=60,
    window_seconds=60,
)
def sales_return_cancel_api(
    request,
    sales_return_id,
):
    if request.method != "POST":
