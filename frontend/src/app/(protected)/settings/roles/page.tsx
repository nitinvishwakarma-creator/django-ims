...
} from "@/features/roles/components/role-permissions-dialog";

import {
  RoleStatusDialog,
} from "@/features/roles/components/role-status-dialog";
  ...
  return (
    <section className="space-y-6">
      ...
      <RoleStatusDialog
        key={
          statusRole
            ? `status-${statusAction}-${statusRole.id}`
            : "status-closed"
        }
